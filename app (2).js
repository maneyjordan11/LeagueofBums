...
function Season() {
  ...
  return el('div', {}, [
    ...
    el('section', { class: 'section band' }, el('div', { class: 'wrap' }, [
      ...
      el('div', { class: 'live-teaser' }, [
        el('p', {}, 'Live weekly matchups, straight from Sleeper, now live on their own tab.'),
        el('div', { class: 'buttons' }, [
          el('button', { class: 'btn', onclick: () => go('schedule') }, 'VIEW FULL SCHEDULE'),
